...
namespace Northwind.Test.Features
{
	...
	public sealed class WeatherForecastFeature : Feature
	{
		...
		public void The_service_should_throw_an_argument_exception()
		{
			...
			Assert.Equal("Can not forcast the past", _serviceException.Message);
		}

		[When(@"The temperature says 70 degrees F")]
		public void The_temperature_says_70_degrees_F()
        {
			_forecast = _weather.ForecastFor(DateTime.Now.AddDays(1));
		...
		public void the_weather_forecast_summary_should_be_Mild()
        {
